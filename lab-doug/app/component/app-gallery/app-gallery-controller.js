    ...
    this.images = [
      {
        ...
        imgSrc: require('../../assset/image/full-size/car-960x540.jpg')
      },
      {
        title: '1977 Corvette',
        desc: 'Clean white lines against the green grass',
        imgSrc: require('../../assset/image/full-size/corvette-960x660.jpg')
      },
      {
        title: 'Jaguar 2015',
        desc: 'black beauty',
        imgSrc: require('../../assset/image/full-size/jaguar-960x639.jpg')
      },
      {
        title: 'Mercedes Coupe',
        desc: '2 Door coupe 2015',
        imgSrc: require('../../assset/image/full-size/mercedes-960x539.jpg')
      },
      {
        title: 'Mercedes SL 650',
        desc: 'McClaren version made from carbon fiber',
        imgSrc: require('../../assset/image/full-size/mercedes-960x640.jpg')
      },
      {
        title: 'Old Timer',
        desc: 'what is this?',
        imgSrc: require('../../assset/image/full-size/oldtimer-960x540.jpg')
      }
    ];
  };
}
